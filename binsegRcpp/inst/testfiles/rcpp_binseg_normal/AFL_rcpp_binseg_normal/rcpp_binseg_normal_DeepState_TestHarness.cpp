...
TEST(binsegRcpp_deepstate_test,rcpp_binseg_normal_test){
  ...
  std::string data_vec_t = "/home/akhila/fuzzer_packages/fuzzedpackages/binsegRcpp/inst/testfiles/rcpp_binseg_normal/AFL_rcpp_binseg_normal/afl_inputs/" + std::to_string(t) + "_data_vec.qs";
  qs::c_qsave(data_vec,data_vec_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data_vec values: "<< data_vec << std::endl;
  IntegerVector kmax(1);
  kmax[0]  = RcppDeepState_int();
  std::string kmax_t = "/home/akhila/fuzzer_packages/fuzzedpackages/binsegRcpp/inst/testfiles/rcpp_binseg_normal/AFL_rcpp_binseg_normal/afl_inputs/" + std::to_string(t) + "_kmax.qs";
