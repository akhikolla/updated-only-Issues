...
TEST(esreg_deepstate_test,G1_fun_test){
  ...
  std::string z_t = "/home/akhila/fuzzer_packages/fuzzedpackages/esreg/inst/testfiles/G1_fun/AFL_G1_fun/afl_inputs/" + std::to_string(t) + "_z.qs";
  qs::c_qsave(z,z_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "z values: "<< z << std::endl;
  IntegerVector type(1);
  type[0]  = RcppDeepState_int();
  std::string type_t = "/home/akhila/fuzzer_packages/fuzzedpackages/esreg/inst/testfiles/G1_fun/AFL_G1_fun/afl_inputs/" + std::to_string(t) + "_type.qs";
