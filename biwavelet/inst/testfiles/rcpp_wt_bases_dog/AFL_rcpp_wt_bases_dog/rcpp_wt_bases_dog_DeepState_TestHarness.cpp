...
TEST(biwavelet_deepstate_test,rcpp_wt_bases_dog_test){
  ...
  std::string k_t = "/home/akhila/fuzzer_packages/fuzzedpackages/biwavelet/inst/testfiles/rcpp_wt_bases_dog/AFL_rcpp_wt_bases_dog/afl_inputs/" + std::to_string(t) + "_k.qs";
  qs::c_qsave(k,k_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "k values: "<< k << std::endl;
  NumericVector scale(1);
  scale[0]  = RcppDeepState_double();
  std::string scale_t = "/home/akhila/fuzzer_packages/fuzzedpackages/biwavelet/inst/testfiles/rcpp_wt_bases_dog/AFL_rcpp_wt_bases_dog/afl_inputs/" + std::to_string(t) + "_scale.qs";
  qs::c_qsave(scale,scale_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "scale values: "<< scale << std::endl;
  IntegerVector param(1);
  param[0]  = RcppDeepState_int();
  std::string param_t = "/home/akhila/fuzzer_packages/fuzzedpackages/biwavelet/inst/testfiles/rcpp_wt_bases_dog/AFL_rcpp_wt_bases_dog/afl_inputs/" + std::to_string(t) + "_param.qs";
