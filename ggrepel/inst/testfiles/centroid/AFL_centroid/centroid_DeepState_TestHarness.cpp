...
TEST(ggrepel_deepstate_test,centroid_test){
  ...
  std::string b_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggrepel/inst/testfiles/centroid/AFL_centroid/afl_inputs/" + std::to_string(t) + "_b.qs";
  qs::c_qsave(b,b_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "b values: "<< b << std::endl;
  NumericVector hjust(1);
  hjust[0]  = RcppDeepState_double();
  std::string hjust_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggrepel/inst/testfiles/centroid/AFL_centroid/afl_inputs/" + std::to_string(t) + "_hjust.qs";
  qs::c_qsave(hjust,hjust_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "hjust values: "<< hjust << std::endl;
  NumericVector vjust(1);
  vjust[0]  = RcppDeepState_double();
  std::string vjust_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ggrepel/inst/testfiles/centroid/AFL_centroid/afl_inputs/" + std::to_string(t) + "_vjust.qs";
