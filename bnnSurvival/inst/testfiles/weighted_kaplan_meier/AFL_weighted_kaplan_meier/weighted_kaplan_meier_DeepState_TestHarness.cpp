...
TEST(bnnSurvival_deepstate_test,weighted_kaplan_meier_test){
  ...
  std::string response_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bnnSurvival/inst/testfiles/weighted_kaplan_meier/AFL_weighted_kaplan_meier/afl_inputs/" + std::to_string(t) + "_response.qs";
  ...
  std::string weights_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bnnSurvival/inst/testfiles/weighted_kaplan_meier/AFL_weighted_kaplan_meier/afl_inputs/" + std::to_string(t) + "_weights.qs";
  qs::c_qsave(weights,weights_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "weights values: "<< weights << std::endl;
  NumericVector timepoints  = RcppDeepState_NumericVector();
  std::string timepoints_t = "/home/akhila/fuzzer_packages/fuzzedpackages/bnnSurvival/inst/testfiles/weighted_kaplan_meier/AFL_weighted_kaplan_meier/afl_inputs/" + std::to_string(t) + "_timepoints.qs";
